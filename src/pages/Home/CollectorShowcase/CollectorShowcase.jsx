    ...
    return (
        <section className='my-10 lg:my-20'>
            <div>
                ...
                <div className='my-10 flex items-center justify-center gap-10 w-full flex-col lg:flex-row p-2'>
                    <div className='border border-primary p-3 lg:w-1/2 rounded-xl' data-aos="fade-up">
